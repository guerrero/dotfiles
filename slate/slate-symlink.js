...
S.cfga({
  ...
  // Hints configs
  "windowHintsBackgroundColor" : [0, 0, 0, 0.84],
  "windowHintsWidth" : "100",
  "windowHintsHeight" : "100",
  "windowHintsFontColor" : [255, 255, 255, 1.0],
  "windowHintsFontName" : "Helvetica",
  "windowHintsFontSize" : "40",
  "windowHintsRoundedCornerSize" : "10",

  // Grid configs
  "gridBackgroundColor" : [0, 0, 0, 0.74],
  "gridRoundedCornerSize" : 5,
  "gridCellBackgroundColor" : [0, 0, 0, 0.84],
  "gridCellSelectedColor" : [0, 0, 0, 0.94],
  "gridCellRoundedCornerSize" : 5,

  // Switch configs
  // "switchIconPadding" : 5,
  // "switchBackgroundColor" : [0, 0, 0, 0.84],
  // "switchSelectedBackgroundColor" : [0, 0, 0, 0.94],
  // "switchSelectedBorderColor" : [0, 0, 0, 0.94],
  // "switchSelectedBorderSize" : 2,
  // "switchRoundedCornerSize" : 5,
  // "switchOnlyFocusMainWindow" : true,
  // "switchShowTitles" : true,
  // "switchFontColor" : [255, 255, 255, 1.0],
  // "switchFontName" : "Helvetica" ,
  // "switchFontSize" : 14,
  // "switchSelectedPadding" : 10
});
